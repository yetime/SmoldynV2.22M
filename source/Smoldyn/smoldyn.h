...
typedef struct rxnstruct {
	...
	double **bindrad2;						// Christine squared binding radii for all surfacexsurface interactions
...
typedef struct surfacestruct {
	int surface_number; 			//Chr: According to surface list in srfss
...
typedef struct simstruct {
	...
	int nrfs;							// Chr:  number of surfaces
